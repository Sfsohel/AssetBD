        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{{route('admin-edit-prop-store')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="prop_name" type="text" placeholder="Your Property Name"
                                           class="form-control" value="{{$products->product_name}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select name="property_type" class="form-control" required>
                                        <option value="{{$products->property_type}}" hidden>{{$products->property_type}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <select id="email" name="property_status" class="form-control" required>
                                        <option value="{{$products->property_status}}" hidden>{{$products->property_status}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="area" name="lot_area" type="number" title="exp: 1200"
                                           class="form-control" min="0" value="{{$products->sqr_ft}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="bed" type="number" title="exp: 3"
                                           class="form-control" min="0" value="{{$products->bed}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="bath" type="number" title="exp: 3"
                                           class="form-control" min="0" value="{{$products->bath}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="year_built" type="text"
                                           ...
                                           class="form-control" value="{{$products->year_built}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="price_per_sqft" name="price_per_sqft" type="number"
                                           ...
                                           onkeydown="totalPriceCalc()" value="{{$products->price_per_sqft}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="total_price" name="total_price" type="number" class="form-control"
                                          value="{{$products->total_price}}" readonly required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" id="more_info" name="more_info"
                                              placeholder="Please enter your message here..." rows="5">{{$products->more_info}} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="phone" type="number" placeholder="Exp: 017-XXXXXXXX"
                                           class="form-control" min="0" value="{{$products->phone}}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="email" type="email" placeholder="Exp: yourmail@mail.com"
                                           class="form-control" value="{{$products->email}}" required>
                                </div>
                            </div>
