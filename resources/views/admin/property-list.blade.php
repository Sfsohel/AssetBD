...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">All Products List</h2>
        </div>
    </div><!--/.row-->
                ...
                <div class="panel-body">
                    ...
                    <table id="prop_table" class="display" style="width:100%">
                        ...
                        @foreach($properties as $property)
                            ...
                            <td>
                                <table><tr>
                                   <td> <a class="btn btn-primary" href="{{ route('admin-edit-prop', [ 'id' => $property->id ]) }}" role="button"><span class="glyphicon glyphicon-pencil"></a>
                                    </td>
                                    <td>  <form action="{{ route('admin-delete-prop') }}" method="post">
                                        {{ @csrf_field() }}
                                        
                                        <a class="btn btn-danger" data-toggle="modal"
                                           data-target="#exampleModalCenter{{$property->id}}" href=""><span class="glyphicon glyphicon-trash"></a>

                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModalCenter{{$property->id}}" tabindex="-1"
                                             role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalCenterTitle">Delete
                                                            ID= {{ $property->product_name}}</h5>
