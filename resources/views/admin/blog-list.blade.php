                    ...
                    <table id="prop_table" class="display" style="width:100%">
                        ...
                        @foreach($blogs as $property)
                            <tr>
                                ...
                                <td>{{$property->short_details}}</td>
                                <td>{{$property->date}}</td>
                                <td>

                                  <table><tr>
                                   <td> <a class="btn btn-primary" href="{{ route('admin-edit-blog', [ 'id' => $property->id ]) }}" role="button"><span class="glyphicon glyphicon-pencil"></a>
                                    </td>
                                    <td>  <form action="{{ route('admin-delete-blog') }}" method="post">
                                        {{ @csrf_field() }}
